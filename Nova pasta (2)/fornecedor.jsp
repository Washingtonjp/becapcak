        ...
        <div class="col-12 col ">
            <div class="container">
				<div class="row justify-content-center">
			      <h1 class= col-10 >Cadastro Fornecedor</h1>
			      <hr>
				</div>
			</div>
	    </header>
            ...
            <div class="container">
                <form action="ServletFornecedor" method="post">
                    <button type="submit" class="btn btn-success mb-3" name="option" value="insertForm" >Adicionar Fornecedor</button>
                        ...
                        <c:forEach var="user" items="${lista}">  
                            <form action="ServletFornecedor" method="post">           	
                                  ...
                                  <input type="hidden" name="id" value="${user.id}"/>
                                   ...
                                   <td>
                                       <button type="submit" name="option" value="updateForm" class="btn-success ">Alterar</button>
                                   </td>      
                                 </tr>
                               </form> 
                       </c:forEach>        
