        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form   action ="Serveletlogin" role="form" class="text-start" method="post" >
                  ...
                  <div class="text-center">
                    <button type="submit" value="Entrar" class="btn bg-gradient-primary w-100 my-4 mb-2 " name = "opcao">Entrar</button>
                  </div>
